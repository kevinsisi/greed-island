...
export function EventTickerStrip() {
  ...
  const head = events[0]
  return (
    <div className="lg:hidden border-t border-ground-800 bg-ground-900/95 px-4 py-2 text-[12px] font-display tracking-tight text-ground-300">
      <div className="flex items-baseline gap-2">
        <span className="text-[10px] uppercase text-ember-500">{t('ticker.heading')}</span>
        {head ? (
