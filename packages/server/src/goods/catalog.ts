...
const GOODS_CATALOG: readonly GoodsSpecies[] = Object.freeze([
  ...
  Object.freeze({ goodsId: 'fiber',        nameZh: '纖維',  unit: 'bundle', tier: 'raw' }        as GoodsSpecies),
  Object.freeze({ goodsId: 'wild_herb',    nameZh: '野草藥',unit: 'bundle', tier: 'raw' }        as GoodsSpecies),
  Object.freeze({ goodsId: 'fungi',        nameZh: '菌類',  unit: 'piece',  tier: 'raw' }        as GoodsSpecies),
