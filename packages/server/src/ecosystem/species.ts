...
const REGION_SPECIES = {
  ...
  forest: [
    ...
    species({ id: 'fog_wolf', category: 'predator', biomeAffinity: ['forest'], dietType: 'carnivore', aggression: 80, fear: 15, intelligence: 35, packBehavior: 'pack', activityWindow: 'night', migrationPattern: 'pressure', reproductionRate: 18, carryingCapacity: 14, predatorTargets: [], preyTargets: ['forest_deer', 'moss_boar'], edibleYield: 2, byproducts: ['pelt', 'fang'], rarity: 'rare', climateTolerance: 72, civilizationTolerance: 10, extinctionThreshold: 3 }),
    species({ id: 'ember_owl', category: 'avian', biomeAffinity: ['forest'], dietType: 'carnivore', aggression: 12, fear: 55, intelligence: 26, packBehavior: 'solitary', activityWindow: 'night', migrationPattern: 'none', reproductionRate: 22, carryingCapacity: 16, predatorTargets: [], preyTargets: ['bark_mantis'], edibleYield: 1, byproducts: ['feathers'], rarity: 'uncommon', climateTolerance: 65, civilizationTolerance: 40, extinctionThreshold: 3 }),
    species({ id: 'bark_mantis', category: 'insect', biomeAffinity: ['forest'], dietType: 'carnivore', aggression: 25, fear: 40, intelligence: 6, packBehavior: 'swarm', activityWindow: 'day', migrationPattern: 'none', reproductionRate: 80, carryingCapacity: 140, predatorTargets: ['ember_owl'], preyTargets: [], edibleYield: 0, byproducts: ['mantis_shell'], rarity: 'common', climateTolerance: 78, civilizationTolerance: 45, extinctionThreshold: 20 }),
  ],
  mountain: [
    ...
    species({ id: 'iron_beak_vulture', category: 'scavenger', biomeAffinity: ['mountain'], dietType: 'scavenger', aggression: 20, fear: 35, intelligence: 20, packBehavior: 'pair', activityWindow: 'day', migrationPattern: 'pressure', reproductionRate: 20, carryingCapacity: 10, predatorTargets: [], preyTargets: ['cliff_goat'], edibleYield: 1, byproducts: ['feathers'], rarity: 'uncommon', climateTolerance: 85, civilizationTolerance: 25, extinctionThreshold: 2 }),
  ...
  desert: [
    ...
    species({ id: 'ash_serpent', category: 'predator', biomeAffinity: ['desert'], dietType: 'carnivore', aggression: 85, fear: 12, intelligence: 18, packBehavior: 'solitary', activityWindow: 'night', migrationPattern: 'pressure', reproductionRate: 18, carryingCapacity: 12, predatorTargets: [], preyTargets: ['dune_lizard', 'sand_runner'], edibleYield: 2, byproducts: ['serpent_scale'], rarity: 'rare', climateTolerance: 95, civilizationTolerance: 6, extinctionThreshold: 2 }),
    ...
    species({ id: 'mirage_hawk', category: 'avian', biomeAffinity: ['desert'], dietType: 'carnivore', aggression: 35, fear: 25, intelligence: 24, packBehavior: 'solitary', activityWindow: 'day', migrationPattern: 'pressure', reproductionRate: 22, carryingCapacity: 14, predatorTargets: [], preyTargets: ['dune_lizard', 'sand_runner'], edibleYield: 1, byproducts: ['feathers'], rarity: 'uncommon', climateTolerance: 88, civilizationTolerance: 18, extinctionThreshold: 3 }),
  ],
  ruin: [
    species({ id: 'ruin_rat', category: 'scavenger', biomeAffinity: ['ruin'], dietType: 'omnivore', aggression: 22, fear: 40, intelligence: 12, packBehavior: 'pack', activityWindow: 'night', migrationPattern: 'pressure', reproductionRate: 72, carryingCapacity: 120, predatorTargets: ['iron_hound'], preyTargets: [], edibleYield: 1, byproducts: ['hide'], rarity: 'common', climateTolerance: 68, civilizationTolerance: 70, extinctionThreshold: 16 }),
    species({ id: 'mimic_mold', category: 'fungal', biomeAffinity: ['ruin'], dietType: 'fungal', aggression: 0, fear: 0, intelligence: 0, packBehavior: 'colony', activityWindow: 'any', migrationPattern: 'none', reproductionRate: 66, carryingCapacity: 90, predatorTargets: [], preyTargets: [], edibleYield: 0, byproducts: ['spores'], rarity: 'uncommon', climateTolerance: 58, civilizationTolerance: 65, extinctionThreshold: 12 }),
    species({ id: 'iron_hound', category: 'predator', biomeAffinity: ['ruin'], dietType: 'carnivore', aggression: 88, fear: 8, intelligence: 20, packBehavior: 'pack', activityWindow: 'night', migrationPattern: 'event_driven', reproductionRate: 10, carryingCapacity: 8, predatorTargets: [], preyTargets: ['ruin_rat', 'lantern_moth'], edibleYield: 2, byproducts: ['iron_fang'], rarity: 'rare', climateTolerance: 75, civilizationTolerance: 5, extinctionThreshold: 1 }),
    species({ id: 'lantern_moth', category: 'avian', biomeAffinity: ['ruin'], dietType: 'filter', aggression: 2, fear: 82, intelligence: 6, packBehavior: 'swarm', activityWindow: 'night', migrationPattern: 'seasonal', reproductionRate: 58, carryingCapacity: 80, predatorTargets: ['iron_hound'], preyTargets: [], edibleYield: 0, byproducts: ['glow_dust'], rarity: 'rare', climateTolerance: 60, civilizationTolerance: 50, extinctionThreshold: 10 }),
  ],
