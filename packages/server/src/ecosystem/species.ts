...
const REGION_SPECIES = {
  ...
  ruin: [
    ...
    species({ id: 'iron_hound', category: 'predator', biomeAffinity: ['ruin'], dietType: 'carnivore', aggression: 88, fear: 8, intelligence: 20, packBehavior: 'pack', activityWindow: 'night', migrationPattern: 'event_driven', reproductionRate: 22, carryingCapacity: 30, predatorTargets: [], preyTargets: ['ruin_rat', 'lantern_moth'], edibleYield: 2, byproducts: ['iron_fang'], rarity: 'rare', climateTolerance: 75, civilizationTolerance: 5, extinctionThreshold: 1 }),
