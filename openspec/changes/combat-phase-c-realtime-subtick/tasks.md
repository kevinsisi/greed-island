...
- [ ] 2.5b Wire the pure evaluator to the live pending-command queue/runtime path; commit resulting EventLog drafts in a single SQLite transaction; flush SSE only after commit.
