# ecosystem-domestication Specification

## Purpose
Defines the domestication lifecycle for livestock species: taming wild animals, breeding, slaughter for goods, mount assignment, and the LivestockRegistryProjection that tracks all owned animals per settlement. Requires the Ranch building to gate capacity.
