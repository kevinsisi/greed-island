# ecology-visibility Specification

## Purpose

First slice of the `ecology-visibility` capability. Player-facing surfaces (Hub map, AreaScene, AI dialog) gain access to the server-authoritative ecology projections that Phases E0 + E1 shipped (animal population, migration routes, fishery density, predator hunger) so the world feels like a living substrate per Part I §6.2.
