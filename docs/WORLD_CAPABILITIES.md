...
| **5. Perception Runtime** | 🟡 Strong | Gemini dialog, ambient narrator, chronicle renderer, anti-hallucination guard; NPC dialog grounded in: beliefs, intents, reflections, episodic memory, relationship graph (friend/rival/trust), household members, alias memory (v0.70.0 — 8-tier relationship title), dominant faction, tile history arcs, ecology (animals, fishery, plants, extinction, pollution, population shifts), rumors, skills, local events | ARCHITECTURE.md §11.9 remaining: long-term social history indexing |
